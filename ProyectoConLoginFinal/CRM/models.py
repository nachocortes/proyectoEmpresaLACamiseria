...
class Cliente(models.Model):
    ...
    # cliente = models.ForeignKey(User, on_delete=models.CASCADE,related_name='clientes_registro',limit_choices_to={'groups__name': 'clientes'},verbose_name="Cliente")
...
class Direccion(models.Model):
    ...
    def __str__(self):
        return f"{self.cliente.nombre},{self.tipoDireccion},{self.calle},{self.numero}, {self.ciudad}"
